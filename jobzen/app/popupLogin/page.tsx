...
const popupLogin: React.FC<PopupProps> = ({ onClose, onConfirm }) => {
  ...
  return (
    <div className="fixed top-20 left-0 right-0 bottom-0 z-50 w-full h-full flex items-center justify-center overflow-hidden">
      <div
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="text-center">
            <i>
              {" "}
              <p className="text-white mb-6">You are login successfully !</p>
            </i>
          </div>
          {/* Footer */}
