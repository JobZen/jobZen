// Import React library and interfaces
...
// Create Popup functional component
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center justify-between w-full mb-6">
           <i> <h3 className="text-3xl font-semibold text-white">Success</h3></i>
            <button
          ...
          <div className="text-center">
           <i> <p className="text-white mb-6">Profile updated successfully !</p></i>
          </div>
          {/* Footer */}
