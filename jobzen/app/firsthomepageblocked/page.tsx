    ...
    axios
      ...
      .then((res) => {
        ...
        const jobsToday = allJobs.filter(
          (job) => job.createdAt.split("T")[0] === today
        );
  ...
  return (
    <div>
      <div className="mt-[7cm]">
        <img
          className="w-[35cm] h-[20cm] ml-[7cm] mt-[3cm] "
          src="https://th.bing.com/th/id/R.d3e239099baf87254265def37ae4c1ac?rik=OHq1uGXE5Z4dmw&riu=http%3a%2f%2fclipartmag.com%2fimages%2fanimated-globe-gif-24.gif&ehk=dlxCICv2kbw7jFqHvlD1mHTe9yXi%2f49K9MNU6FUR2GU%3d&risl=&pid=ImgRaw&r=0"
          alt=""
        />
        <div className="ml-[19cm]">
          <p className="font-bruno text-blueghamek text-6xl text-opacity-60 ">
            JOB ZEN
          </p>
          <p className="font-jolly-lodger text-blueghamek text-2xl text-opacity-60 ml-[1cm]">
            {" "}
            Connecting Freelancers Above the Rest!
          </p>
      ...
      <div className="bg- malek flex justify-between ml-[10%] mr-[10%] gap-3">
        {jobcategory.map((el, i) => (
          <div key={i} className="relative text-center ">
            <Link href={`/landingPage`}>
              <h1 className="text-4xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white z-10 hover:scale-125 ">
                {el.category}
              </h1>
            </Link>
            <img
      ...
      <div className="flex flex-col md:flex-row items-center justify-center h-[25cm] bg-aloui   bg-no-repeat bg-cover bg-bottom mt-[3cm]">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-16 text-center md:text-left ">
          <h1 className="text-4xl md:text-8xl font-bold text-white ml-[6cm]">
            JOBZEN
          </h1>
          <p className="text-xl md:text-4xl text-white mt-4 ml-[3cm]">
            GATEWAY TO SUCCESS AWAITS!
          </p>
          <p className="text-xl md:text-2xl text-white mt-4 ml-[3cm]">
            Discover your next career move or find the perfect freelancer
            effortlessly on our platform. Connecting talent with opportunities,
            our user-friendly website simplifies job hunting and freelancing.
          </p>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-center mr-[1.5cm]">
                        <img
                          ...
                          src="https://th.bing.com/th/id/OIP.RJwgX7x98VNnkH02LQ0L-AHaHa?rs=1&pid=ImgDetMain"
                          alt=""
                        />
      ...
      <p className="text-4xl font-jura mt-[4cm] ml-[17cm]">
        Trusted By Teams Around The World
      </p>
      <div className="mt-[4cm]">
        <div className=" mx-auto px-4 md:px-8 ">
          <div className="flex justify-center">
            <ul className="inline-grid grid-cols-2 gap-x-4 gap-y-[2cm] md:gap-x-[5cm] md:grid-cols-3 lg:grid-cols-4 ">
              {/* LOGO 1 */}
              <li>
                <svg
                  className="w-[8cm] my-auto"
                  viewBox="0 0 163 48"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
