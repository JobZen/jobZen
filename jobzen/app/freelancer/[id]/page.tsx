...
const Freelancer = ()=> {
    ...
    if (!free) {
        return <div>winou mqnedrouch!</div>;
    }
        ...
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div className="col-span-4 sm:col-span-3">
                <div className="bg-white shadow rounded-lg p-6">
                    ...
                    <div className="mt-6 flex flex-wrap gap-4 justify-center">
                      ...
                      <Link href={`/freelancer/${free.id}/Update`}>
                    ...
                    <ul>
                            {free.skills.split(',').map((skill, index) => (
                                <li key={index} className="mb-2">{skill.trim()}</li>
                            ))}
                        </ul>
                    </div>
                </div>
            ...
            <div className="col-span-4 sm:col-span-9">
                <div className="bg-white shadow rounded-lg p-6">
                    ...
                    <p className="text-gray-700">{free.aboutMe}
                    </p>
                    <br />
                    <div className="mb-6">
                    ...
                    <div className="mb-6">
                        <div className="flex justify-between flex-wrap gap-2 w-full">
                            <span className="text-gray-700 font-bold">{free.jobtitle}</span>
                        </div>
                        <p className="mt-2">
                            {free.experience}	
                        </p>
