        ...
        <div className="profile-card w-full rounded-md shadow-xl overflow-hidden z-[100] relative cursor-pointer snap-start shrink-0 bg-white flex flex-col items-center justify-center gap-3 transition-all duration-300 group">
          <div className="avatar w-full pt-5 flex items-center justify-center flex-col gap-1">
              ...
              <img
                ...
                className="size-46 z-40 border-4 border-[#172554] rounded-full group-hover:border-8 group-hover:transition-all group-hover:duration-300 transition-all duration-300"
              />
          ...
          id="phone"
          viewBox="0 0 24 24"
          class="fill-stone-700 group-hover:fill-[#172554]"
          height="15"
          width="15"
          xmlns="http://www.w3.org/2000/svg"
        >
